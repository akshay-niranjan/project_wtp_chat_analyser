...
st.set_option('deprecation.showPyplotGlobalUse', False)  # silence warnings
    ...
    if st.sidebar.button("Show Analysis"):
        ...
        with col2:
            ...
            ax.pie(
                ...
                labels=emoji_df[0],
                autopct='%0.2f%%',
                textprops={'fontsize': 12, 'fontname': 'Segoe UI Emoji'}
            )
            st.pyplot(fig)

st.sidebar.title('Steps to Export Whatsapp Chat')
st.sidebar.write('1. Go to your chat')
st.sidebar.write('2. Click on 3 dots → More')
st.sidebar.write('3. Export chat (Without Media)')
